...
public class Halstead {
	...
	private void calcularMetricas(String codigo) {
	    ...
	    longitud = operadoresTotales + operandosTotales;
	    
	    volumen = (float) (longitud * Math.log10(operandosUnicos + operadoresUnicos) / Math.log10(2));
	    
	    esfuerzo = (double) ((operadoresUnicos/2)*(operandosTotales/(double)operandosUnicos)) * volumen;
